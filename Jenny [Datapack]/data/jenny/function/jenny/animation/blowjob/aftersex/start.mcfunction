tag @s remove jenny.blowjob
tag @s remove jenny.blowjob.suck
tag @s remove jenny.blowjob.thurst
scoreboard players set @s jenny.animation 220
...
scoreboard players operation #gametime main_score %= #236 const
...
item modify entity @s armor.head jenny:blowjob/cum
