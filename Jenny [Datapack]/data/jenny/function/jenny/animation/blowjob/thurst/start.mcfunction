...
scoreboard players set @s jenny.animation 35
...
scoreboard players operation #gametime main_score %= #35 const
...
item modify entity @s armor.head jenny:blowjob/thurst
tag @s add jenny.blowjob.thurst